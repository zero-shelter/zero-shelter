...
| OUTPUT-07 | P1 | A clean dependency run is mistaken for a whole-project security result. | The CLI names only present unscanned local domains in text and JSON without judging them. | CI | `test/unscanned-boundary.test.ts` |
